...
document.addEventListener("DOMContentLoaded", function() {
    document.querySelector(".post").addEventListener("click", function() {
        window.location.href = "manager/post.jsp"; //
    });
});
...
document.addEventListener("DOMContentLoaded", function() {
    document.querySelector(".list-room").addEventListener("click", function() {
        window.location.href = "manager/listRoom.jsp";
    });
});
...
document.addEventListener("DOMContentLoaded", function() {
    document.querySelector(".list-book-room").addEventListener("click", function() {
        window.location.href = "manager/listBookRoom.jsp";
    });
});

document.addEventListener("DOMContentLoaded", function() {
    document.querySelector(".list-staff").addEventListener("click", function() {
        window.location.href = "manager/listStaff.jsp";
    });
});
...
document.addEventListener("DOMContentLoaded", function() {
    document.querySelector(".account").addEventListener("click", function() {
        window.location.href = "manager/admin.jsp";
    });
});
